...
public class SpyContext implements ChannelHandlerContext {

    public SpyChannel channel = new SpyChannel();
    ...
    @Override
    public ChannelHandlerContext fireChannelRead(Object msg) { return null; }
    @Override
